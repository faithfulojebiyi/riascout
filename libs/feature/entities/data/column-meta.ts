...
export const COLUMN_META: Readonly<Record<string, ColumnMeta>> = {
  ...
  'firm.discretionary_account_count': { group: 'Firm metrics' },
  'firm.non_discretionary_account_count': { group: 'Firm metrics' },
  'firm.account_count': { group: 'Firm metrics' },
  'firm.reported_client_count_min': { group: 'Firm metrics' },
  'firm.reported_client_count_max': { group: 'Firm metrics' },
  'firm.reported_client_count_quality': { group: 'Firm metrics' },
...
export const ICON_OVERRIDES: Readonly<Record<string, string>> = {
  ...
  'advisor.firm_discretionary_account_count': 'users',
  'advisor.firm_non_discretionary_account_count': 'users',
  'advisor.firm_account_count': 'users',
  'advisor.firm_reported_client_count_min': 'users',
  'advisor.firm_reported_client_count_max': 'users',
  'firm.discretionary_account_count': 'users',
  'firm.non_discretionary_account_count': 'users',
  'firm.account_count': 'users',
  'firm.reported_client_count_min': 'users',
  'firm.reported_client_count_max': 'users',
