...
export const REFERENCE_COLUMNS: ReadonlyMap<string, ReferenceColumn> = new Map([
  ...
  advisor('current_firm_source', 'text'),
  advisor('current_firm_observed_on', 'date'),
  ...
  advisor('firm_discretionary_account_count', 'number'),
  advisor('firm_non_discretionary_account_count', 'number'),
  advisor('firm_account_count', 'number'),
  advisor('firm_reported_client_count_min', 'number'),
  advisor('firm_reported_client_count_max', 'number'),
  advisor('firm_reported_client_count_quality', 'text'),
  ...
  advisor('firm_aum_per_account', 'currency'),
  ...
  firm('aum_band', 'text'),
  firm('discretionary_account_count', 'number'),
  firm('non_discretionary_account_count', 'number'),
  firm('account_count', 'number'),
  firm('reported_client_count_min', 'number'),
  firm('reported_client_count_max', 'number'),
  firm('reported_client_count_quality', 'text'),
  firm('employee_count', 'number'),
  firm('advisor_count', 'number'),
  firm('observed_advisor_count', 'number'),
  firm('advisor_linkage_status', 'text'),
  firm('aum_per_advisor', 'currency'),
  firm('aum_per_account', 'currency'),
