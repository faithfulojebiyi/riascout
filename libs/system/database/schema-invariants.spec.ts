...
describe('schema invariants', () => {
  ...
  describe('check constraints', () => {
    const checks = [
      ...
      'private_fund_percentage_range',
      'private_fund_nonnegative_measures',
      'private_fund_audit_opinion_valid',
      'private_fund_related_role_valid',
      'private_fund_manager_role_valid',
      'private_fund_authority_role_valid',
      'private_fund_adviser_role_valid',
      'private_fund_provider_role_valid',
      'private_fund_provider_statement_scope',
