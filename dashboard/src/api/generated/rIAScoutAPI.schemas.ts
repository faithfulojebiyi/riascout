...
export type GetJobResponseStatus = typeof GetJobResponseStatus[keyof typeof GetJobResponseStatus];


export const GetJobResponseStatus = {
  queued: 'queued',
  running: 'running',
  completed: 'completed',
  failed: 'failed',
...
export type GetJobResponsePayload = {
  listId?: string;
  entityId?: string;
  sourceKind?: string;
};
