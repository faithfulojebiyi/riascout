...
import { Box, Flex, styled } from '@riascout-ui/styled-system/jsx';
...
export type CommandInputVariants = RecipeVariantProps<
  typeof commandInputStyles
>;
    ...
    >
      {showIcon && (
        <Box {...iconWrapperProps}>
          {icon ? icon : <Icons.searchNormal size={12} />}
        </Box>
      )}
