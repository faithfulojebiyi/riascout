...
import { JsxStyleProps, RecipeVariantProps } from '@riascout-ui/styled-system/types'
...
export type SliderRangeProps = React.ComponentProps<typeof SliderPrimitive.Range> & JsxStyleProps & RangeVariants
