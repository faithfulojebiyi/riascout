...
select f.firm_crd,
       ...
       fm.discretionary_account_count::int,
       fm.non_discretionary_account_count::int,
       fm.account_count::int,
       fm.reported_client_count_min::int,
       fm.reported_client_count_max::int,
       fm.reported_client_count_quality,
       fm.employee_count::int,
       ...
       fdv.aum_per_advisor, fdv.aum_per_account, fdv.aum_per_employee,
...
insert into market.firm_search (
  ...
  employee_count, advisory_employee_count, office_count, advisor_count,
  observed_advisor_count, advisor_linkage_status,
  aum_per_advisor, aum_per_account, aum_per_employee,
